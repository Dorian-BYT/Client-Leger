...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Modifier la panne') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('panne.update', $panne->idPanne) }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text"
                                           ...
                                           value="{{ old('description', $panne->description) }}" required>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="{{ route('lesMateriels') }}" class="btn btn-secondary">
                                        {{ __('Annuler') }}
                                    </a>
                                </div>
                            </div>
